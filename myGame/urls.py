...
from theGame.views import main , team, tutorial,end, taskChoiceBlue,taskChoiceRed,blue1, blue2,task1, task2,task3,task4,task5,task6, task7,result, about , scoring
